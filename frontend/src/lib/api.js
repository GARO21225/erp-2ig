...
export const toptelsigAPI = {
  ...
  crmARelancer: () => api.get('/toptelsig/crm/a-relancer'),
  ...
  campagnesCanaux: () => api.get('/toptelsig/campagnes/canaux'),
  campagnes: (params) => api.get('/toptelsig/campagnes', { params }),
  campagne: (id) => api.get(`/toptelsig/campagnes/${id}`),
  createCampagne: (data) => api.post('/toptelsig/campagnes', data),
  updateEnvoiCampagne: (campagneId, envoiId, data) => api.put(`/toptelsig/campagnes/${campagneId}/envois/${envoiId}`, data),
  annulerCampagne: (id) => api.put(`/toptelsig/campagnes/${id}/annuler`),
